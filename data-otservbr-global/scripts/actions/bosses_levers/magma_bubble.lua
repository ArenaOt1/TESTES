...
--local boss = Position(33653, 32901, 15)
--
--local config = {
--
--	boss = {
--		name = "Magma Bubble", -- --Inserir nome do Boss " " 
--		createFunction = function()
--			local bossBoss = Game.createMonster("Magma Bubble", boss, true, true) --Inserir nome do Boss " "
--			return bossBoss
--		end,
--	},
--
