...
--local boss = Position(33904, 31351, 14)

--local config = {

--	boss = {
--		name = "Ratmiral Blackwhiskers", -- --Inserir nome do Boss " " 
--		createFunction = function()
--			local bossBoss = Game.createMonster("Ratmiral Blackwhiskers", boss, true, true) --Inserir nome do Boss " "
--			return bossBoss
--		end,
--	},
--
