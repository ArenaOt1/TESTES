local boss = Position(33837, 32591, 12)

local config = {

	boss = {
		name = "The Monster", -- --Inserir nome do Boss " " 
		createFunction = function()
			local bossBoss = Game.createMonster("The monster", boss, true, true) --Inserir nome do Boss " "
			return bossBoss
		end,
	},
	requiredLevel = 250,
