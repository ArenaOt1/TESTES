local internalNpcName = "Captain ino"
...
npcConfig.voices = {
	interval = 15000,
	chance = 50,
	{ text = "Passages to Thais and vip islands! Visit the strange lands!" },
}
...
addTravelKeyword("cidade vip", 150, Position(32848, 30937, 6))
...
-- Basic
--keywordHandler:addKeyword({ "name" }, StdModule.say, { npcHandler = npcHandler, text = "Ah, you may not have heard of me. I am Captain kevin, the first Oramondian for a hundred years to have sailed through the mist to your strange lands." })
...
keywordHandler:addKeyword({ "sail" }, StdModule.say, { npcHandler = npcHandler, text = "You would like to book a passage for {cidade vip} {}?" })
...
keywordHandler:addKeyword({ "passage" }, StdModule.say, { npcHandler = npcHandler, text = "You would like to book a passage for {cidade vip} {}?" })
...
npcHandler:setMessage(MESSAGE_GREET, "salve cachorro, Sir |PLAYERNAME|. Where can I {sail} you today?")
