...
--  Itens
{
	...
	name = "Itens",
	rookgaard = true,
	subclasses = {"Sanguine", "Soul", "Falcon", "Lion", "Gnome", "Cobra", "Destruction"},
},
	...
	-- Sanguine
	{
		icons = { "Category_ExclusiveOffers.png" },
		   ...
		   offers = {
			...
			--    {
			-- 	   icons = { "Sanguine Blade.png" },
			-- 	   name = "Sanguine Blade",
			-- 	   price = 4000,
			-- 	   itemtype = 43864,
			-- 	   charges = 1,
            -- movable = 0,
			-- 	   description = "(Atk: 8 + 46 fire, Def: 32 +3, sword fighting +5, life leech +6%, mana leech +3%). It can only be wielded properly by knights of level 600 or higher.",
			-- 	   type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			--    },
			--    {
			-- 	   icons = { "Sanguine Bludgeon.png" },
			-- 	   name = "Sanguine Bludgeon",
			-- 	   price = 4000,
			-- 	   itemtype = 43872,
			-- 	   charges = 1,
            -- movable = 0,
			-- 	   description = "(Atk: 8 + 50 earth, Def: 35, club fighting +5, critical hit chance 10%, critical extra damage +12%).It can only be wielded properly by knights of level 600 or higher.",
			-- 	   type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			--    },
			--    {
			-- 	   icons = { "Sanguine Boots.png" },
			-- 	   name = "Sanguine Boots",
			-- 	   price = 4000,
			-- 	   itemtype = 43884,
			-- 	   charges = 1,
            -- movable = 0,
			-- 	   description = "(Arm: 3, magic level +2, speed +10, death magic level +1, protection protection physical +2%, ice +8%).It can only be wielded properly by sorcerers of level 500 or higher.Augments: (Avatar of Storm -> -900s cooldown, Hell's Core -> +8% critical extra damage, Energy Wave -> +8% critical extra damage).Imbuement Slots: 1.It weighs 19.00 oz.",
			-- 	   type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			--    },
			--    {
			-- 	   icons = { "Sanguine Bow.png" },
			-- 	   name = "Sanguine Bow",
			-- 	   price = 4000,
			-- 	   itemtype = 43877,
			-- 	   charges = 1,
            -- movable = 0,
			-- 	   description = "(Range: 6, Atk: +9, Hit% +6, distance fighting +4, protection earth +6%, critical hit chance 10%, critical extra damage +12%).",
			-- 	   type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			--    },
			--    {
			-- 	   icons = { "Sanguine Coil.png" },
			-- 	   name = "Sanguine Coil",
			-- 	   price = 4000,
			-- 	   itemtype = 43882,
			-- 	   charges = 1,
            -- movable = 0,
			-- 	   description = "(magic level +5, fire magic level +1, energy magic level +1, protection earth +7%, critical hit chance 10%, critical extra damage +12%, life leech +2%, mana leech +1%).",
			-- 	   type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			--    },
			--    {
			-- 	   icons = { "Sanguine Crossbow.png" },
			-- 	   name = "Sanguine Crossbow",
			-- 	   price = 4000,
			-- 	   itemtype = 43879,
			-- 	   charges = 1,
            -- movable = 0,
			-- 	   description = "(Range: 6, Atk: +10, Hit% +7, distance fighting +4, protection fire +6%, critical hit chance 10%, critical extra damage +12%).",
			-- 	   type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			--    },
			--    {
			-- 	   icons = { "Sanguine Cudgel.png" },
			-- 	   name = "Sanguine Cudgel",
			-- 	   price = 4000,
			-- 	   itemtype = 43866,
			-- 	   charges = 1,
            -- movable = 0,
			-- 	   description = "(Atk: 8 + 46 death, Def: 32 +3, club fighting +5, life leech +6%, mana leech +3%).",
			-- 	   type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			--    },
			--    {
			-- 	   icons = { "Sanguine Galoshes.png" },
			-- 	   name = "Sanguine Galoshes",
			-- 	   price = 4000,
			-- 	   itemtype = 43887,
			-- 	   charges = 1,
            -- movable = 0,
			-- 	   description = "(Arm: 3, magic level +2, speed +10, healing magic level +1, protection protection physical +2%, fire +8%).",
			-- 	   type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			--    },
			--    {
			-- 	   icons = { "Sanguine Greaves.png" },
			-- 	   name = "Sanguine Greaves",
			-- 	   price = 4000,
			-- 	   itemtype = 43881,
			-- 	   charges = 1,
            -- movable = 0,
			-- 	   description = "(Arm: 11, distance fighting +4, holy magic level +1, protection protection physical +7%, energy +9%).",
			-- 	   type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			--    },
			--    {
			-- 	   icons = { "Sanguine Hatchet.png" },
			-- 	   name = "Sanguine Hatchet",
			-- 	   price = 4000,
			-- 	   itemtype = 43868,
			-- 	   charges = 1,
            -- movable = 0,
			-- 	   description = "(Atk: 8 + 46 fire, Def: 32 +3, axe fighting +5, life leech +6%, mana leech +3%).",
			-- 	   type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			--    },
			--    {
			-- 	   icons = { "Sanguine Legs.png" },
			-- 	   name = "Sanguine Legs",
			-- 	   price = 4000,
			-- 	   itemtype = 43876,
			-- 	   charges = 1,
            -- movable = 0,
			-- 	   description = "(Arm: 12, sword fighting +4, axe fighting +4, club fighting +4, protection protection physical +9%, death +6%).",
			-- 	   type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			--    },
			--    {
			-- 	   icons = { "Sanguine Razor.png" },
			-- 	   name = "Sanguine Razor",
			-- 	   price = 4000,
			-- 	   itemtype = 43870,
			-- 	   charges = 1,
            -- movable = 0,
			-- 	   description = "(Atk: 8 + 50 energy, Def: 35, sword fighting +5, critical hit chance 10%, critical extra damage +12%).",
			-- 	   type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			--    },
			--    {
			-- 	   icons = { "Sanguine Rod.png" },
			-- 	   name = "Sanguine Rod",
			-- 	   price = 4000,
			-- 	   itemtype = 43885,
			-- 	   charges = 1,
            -- movable = 0,
			-- 	   description = "(magic level +5, ice magic level +1, earth magic level +1, protection death +7%, critical hit chance 10%, critical extra damage +5%, life leech +6%, mana leech +3%).",
			-- 	   type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			--    },
		   },
	},
...
-- Primal
{
 icons = { "Category_ExclusiveOffers.png" },
	...
	offers = {
		...
		-- 	charges = 1,
        --     movable = 0,
		-- 	description = "(magic level +1, Perfect Shot +20 at range 3)",
		-- 	type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
		-- },
		-- {
		...
		-- 	charges = 1,
        --     movable = 0,
		-- 	description = "(holy magic level +1, protection energy +4%, earth +4%, fire +4%, ice +4%)",
		-- 	type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
		-- },
		-- {
		...
		-- 	charges = 1,
        --     movable = 0,
		-- 	description = "(Arm:9, magic level +3, healing magic level +1, protection physical +2%, ice +9%)",
		-- 	type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
		-- },
		-- {
		...
		-- 	charges = 1,
        --     movable = 0,
		-- 	description = "(healing magic level +2, protection energy +4%, earth +4%, fire +4%, ice +4%)",
		-- 	type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
		-- },
		-- {
		...
		-- 	charges = 1,
        --     movable = 0,
		-- 	description = "(Def:22, magic level +5, healing magic level +1, ice magic level +1, protection physical +4%, energy +6%)",
		-- 	type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
		-- },
		-- {
		...
		-- 	charges = 1,
        --     movable = 0,
		-- 	description = "(Def:22, magic level +5, energy magic level +1, fire magic level +1, protection physical +3%, fire +8%)",
		-- 	type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
		-- },
		-- {
		...
		-- 	charges = 1,
        --     movable = 0,
		-- 	description = "(Arm:9, magic level +3, fire magic level +1, protection physical +3%, earth +7%)",
		-- 	type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
		-- },
		-- {
		...
		-- 	charges = 1,
        --     movable = 0,
		-- 	description = "(energy magic level +1, fire magic level +1, protection energy +4%, earth +4%, fire +4%, ice +4%)",
		-- 	type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
		-- },
		-- {
		...
		-- 	charges = 1,
        --     movable = 0,
		-- 	description = "(Arm:20, club fighting +4, sword fighting +4, axe fighting +4, damage reflection +19, protection physical +13%)",
		-- 	type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
		-- },
		-- {
		-- 	icons = { "Spiritthorn helmet.png" },
		-- 	name = "Spiritthorn Helmet",
		-- 	price = 2500,
		-- 	itemtype = 39148,
		-- 	charges = 1,
        --     movable = 0,
		-- 	description = "(Arm:12, club fighting +3, sword fighting +3, axe fighting +3, damage reflection +13, protection physical +6%, energy +10%)",
		-- 	type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
		-- },
		-- {
		...
		-- 	charges = 1,
        --     movable = 0,
		-- 	description = "(protection physical +2%, energy +4%, earth +4%, fire +4%, ice +4%)",
		-- 	type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
		-- },
	},
},
    ...
    --exclusivo 
		...
		icons = { "Category_ExclusiveOffers.png" },
		   ...
		   offers = {
			...
			{
				icons = { "eye of the storm.png" },
				name = "Infinity Teleport",
				price = 450,
				itemtype = 19369,
				count = 1,
				movable = 0,
				description = "Instantly teleport to any temple in the world. A blessing for adventurers who value time over travel.",
			...
			count = 1,
			movable = 0,
			description = "2 imbuiment slot, 30 mana regen and 30 life regen.",
			type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
			icons = { "purifier for lost souls.png" },
			name = "Trader of Dimensions",
			price = 3000,
			itemtype = 32226,
			count = 1,
			movable = 0,
			description = "sell all loot from their loot pouch simply by right-clicking.",
			type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
	    },
	},
