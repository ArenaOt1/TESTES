...
{name = "Medusa", color = 40, total = 2500, type = "once", storage = 190026, storagecount = 190027, 
rewards = { 
{3393, 1},
	},
},

{name = "Demon", color = 40, total = 6666, type = "once", storage = 190028, storagecount = 190029, 
rewards = { 
{3365, 1},
	},
},
...
{name = "Cloak Of Terror", color = 40, total = 10000, type = "once", storage = 190032, storagecount = 190033, 
rewards = { 
{"exp", 30000000},
	},
},

{name = "Vibrant Phantom", color = 40, total = 10000, type = "once", storage = 190034, storagecount = 190035, 
rewards = { 
{"exp", 30000000},
	},
},

{name = "Courage Leech", color = 40, total = 10000, type = "once", storage = 190036, storagecount = 190037, 
rewards = { 
{"exp", 30000000},
	},
},

{name = "Brachiodemon", color = 40, total = 10000, type = "once", storage = 190038, storagecount = 190039, 
rewards = { 
{"exp", 30000000},
	},
},

{name = "Infernal Demon", color = 40, total = 10000, type = "once", storage = 190040, storagecount = 190041, 
rewards = { 
{34109, 2},
	},
},

{name = "Infernal Phantom", color = 40, total = 10000, type = "once", storage = 1900042, storagecount = 1900043, 
rewards = { 
{"exp", 30000000},
	},
},

{name = "Bony Sea Devil", color = 40, total = 10000, type = "daily", storage = 1900044, storagecount = 1900045, 
rewards = { 
{"exp", 30000000},
	},
},

{name = "Turbulent Elemental", color = 40, total = 10000, type = "once", storage = 1900046, storagecount = 1900047, 
rewards = { 
{"exp", 30000000},
	},
},

{name = "Capricious Phantom", color = 40, total = 10000, type = "once", storage = 1900048, storagecount = 1900049, 
rewards = { 
{"exp", 30000000},
	},
},
--
--{name = "Juggernaut", color = 40, total = 25000, type = "once", storage = 190050, storagecount = 190051, 
--rewards = { 
--{3422, 1},
--	},
--},

{name = "Dawnfire Asura", color = 40, total = 1000, type = "daily", storage = 190052, storagecount = 190053, 
rewards = { 
{"exp", 20000000},
	},
},
...
local data = getTaskByStorage(storage)
	...
	if kills + count >= data.total then
		player:sendTextMessage(MESSAGE_EVENT_ADVANCE, "[Task System] Voce terminou essa task! Para receber sua recompensa use !task")
		return player:setStorageValue(data.storagecount, data.total)
	end
		player:sendTextMessage(MESSAGE_EVENT_ADVANCE, "[Task System] Total de Cristuras derrotadas: [".. kills + count .. "/".. data.total .."] "..data.name ..".")
