local function targetFunction(creature, target)
	...
	local min = ((player:getLevel() / 5) + (player:getMagicLevel() * 8.7) + 26) -- local min = ((player:getLevel() / 5) + (player:getMagicLevel() * 5.7) + 26)
	local max = ((player:getLevel() / 5) + (player:getMagicLevel() * 14.43) + 62) -- local max = ((player:getLevel() / 5) + (player:getMagicLevel() * 10.43) + 62)
